    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <title>Product Detail - Nguyễn Quân</title>
                                    ...
                                    <div class="col-12 mx-auto">
                                        ...
                                        <div class="card" style="width: 60%">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Detail_Desc: ${product.detailDesc}</li>
                                                <li class="list-group-item">Price: ${product.price}</li>
                                                <li class="list-group-item">Quantity: ${product.price}</li>
                                                <li class="list-group-item">Short_Desc: ${product.shortDesc}</li>
